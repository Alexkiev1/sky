    ...
    return (
        <nav className="bg-gray-900/50 backdrop-blur-sm border-t border-gray-700">
            <div className="max-w-md mx-auto flex justify-around p-2">
                <NavLink to="/" className={({ isActive }) => `flex flex-col items-center justify-center w-full p-2 rounded-lg transition-colors duration-300 ${isActive ? activeLink : inactiveLink}`}>
